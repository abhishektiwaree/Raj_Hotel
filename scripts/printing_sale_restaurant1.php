	...
	<body>
		<div id="wrapper">
			...
			<div id="invoice">
				<div id="bill_detail">
					<table border="0" bordercolor="#ccc" cellpadding="0" cellspacing="0" width="100%"> 
						<tr><td style="text-align:  center"; colspan="2"><span style="text-decoration: underline;">CASH MEMO</td></tr>
						<tr>
							...
							<td style="text-align: right;">Date: <?php echo date("d-m-Y",strtotime($invoice['timestamp']));?></td>
							</div>
						</tr>
						<tr>
							...
							<td style="text-align:  right">
								Waiter : <?php echo $invoice['waitor_name']; ?>
							</td>
						</tr>
						<tr>
							<td style="text-align:  left">
								KOT: <?php echo $invoice['kot_no']; ?>
							</td>
							<td style="text-align:  right">Invoice : <?php echo $invoice['invoice_no'];?>
							</td>
				...
				<table border="0" bordercolor="#ccc"  cellpadding="0"  cellspacing="0" width="100%">
					<div id="bill">
						...
						<?php 
						$sql11 = 'select * from stock_sale_restaurant where invoice_no="'.$_SESSION['invoice_no'].'"';
						$res= execute_query($sql11); 
						$tot_price=0;
						$tot_amount=0;
						$qty=0;
						$i=0;
						...
						?>
						<tr>
							<td colspan="<?php echo $total_col-2; ?>" style="text-align:right; padding-right:10px; border:1px solid;"><b>Round Off:</b></td>
							<td style="border:1px solid; text-align:right;"><?php echo $invoice['round_off'];?></td>
						</tr>
						<?php } ?>
						<tr>
							<td colspan="<?php echo $total_col-2; ?>" style="text-align:center; padding-right:10px; border-top:1px solid;border-left:1px solid;"><b>CGST : 2.5%</b></td>
							<td style="border:1px solid; text-align:right;"><?php echo $invoice['tot_vat'];?></td>
						</tr>
						<tr>
							<td colspan="<?php echo $total_col-2; ?>" style="text-align:center;border-left:1px solid;"><b>SGST : 2.5%</b></td>
							<td style="border:1px solid; text-align:right;"><?php echo $invoice['tot_sat'];?></td>
						</tr>
						<?php
						if($invoice['other_discount']>0){
						?>
						...
						<tr>
							<td colspan="<?php echo $total_col-2; ?>" style="text-align:center;border-left:1px; ">Other Discount (-):</td>
							<td style="border:1px solid; text-align:right;"><?php echo $invoice['other_discount'];?></td>
						</tr>
						<?php } ?>
						
						<tr>
							<td colspan="<?php echo $total_col-2; ?>" style="text-align:right; padding-right:10px; border:1px solid;"><b>Amount Payable:</b></td>
							<td style="text-align:right; border:1px solid;"><?php echo $invoice['grand_total'];?></td>
						</tr>
						<tr>
						...
						<tr>
							<td colspan="<?php echo $total_col; ?>">In Words.: <?php 
							$tot_amount = round(($invoice['grand_total']),0);
						...
						if($firm_type=='composition'){
							...
							?><tr>
							<td colspan="<?php echo $total_col; ?>"><b>UNDER COMPOSITION SCHEME<br>NO ITC CLAIM</b></td>
