	...
	<body>
		<div id="wrapper">
			...
			<div id="company_info">
				...
				<div id="company">
					<div id="logo"><img src="../images/logo.gif"/><!--<?php echo $company; ?>-->VANDANA RESTAURANT <span style="font-size:8px"> A UNIT OF ABHA HOTEL</span></div><br />
					<div id="slogan"><?php echo $slogan; ?></div>
					<div id="dealer" style="line-height:15px;"><?php echo $dealer; ?></div>
				</div>
				<div id="address">
					<p style="font-size:12px; font-weight:bold; line-height:15px;"><?php echo $address; ?></p>
					<?php echo $contact; ?>
					<?php 
						if($gstin!=''){
							echo "<br/><strong>GSTIN : $gstin</strong>";
		...
		<div id="wrapper">
			...
			<div id="company_info">
				...
				<div id="company">
					...
					<div id="logo"><h1 style="font-size:20px;letter-spacing:3px">INDRAPRASTHA INN</h1></div>
				</div>
				
			<div id="address" style="margin-top:15px">
				<p style="font-size:16px;letter-spacing: 1px"> 8, Patel Puram,Near New Laxmi Market,Gomtinagar Extension,</p><p style="font-size:16px;margin-top:5px;"> Janeshwar Mishra Park Gate 1,Lucknow, Uttarpradesh, India</p>
			</div>
			
			<br>
			<div id="address" style="margin-top:10px">
				<p style="font-size:15px;letter-spacing: 1px">Contact No.:05227166490, 8687892626</p>
			</div>
			<br>
			<div id="address" style="margin-top:15px">
				<p style="font-size:15px;letter-spacing: 1px;margin-top:-5px;">E-Mail : stay.ipinn@gmail.com</p>
			</div>
			<div id="address" style="margin-top:10px">
				<p style="font-size:15px;letter-spacing: 1px"></p>
			</div>
			<div id="address" style="margin-top:10px">
				<p style="font-size:15px;letter-spacing: 1px;margin-top:-18px;"><?php
						if($gstin!=''){
							echo "<br/><strong style='font-size:15px;letter-spacing: 1px'>GSTIN : XXXXXX</strong>";
						}
					?> </p>
			</div>
			<div id="address" style="margin-top:10px">
			...
			<div id="invoice">
				...
				<table border="0" bordercolor="#ccc"  cellpadding="0"  cellspacing="0" width="100%">
					<div id="bill">
						...
						<tr>
							<td colspan="4" style="text-align:center;border-left:1px solid;font-size:13px"><b style="font-size:13px"><b style="font-size:13px">SGST : 2.5%</b></td>
						...
						<tr style="height:20px">
							...
							<td style="text-align:right; border:1px solid;font-size:13px"><?php echo round($invoice['grand_total'] , 2);?></td>
						</tr>
						<tr>
							<td colspan="<?php echo $total_col; ?>" style="border:0px solid;font-size:13px">&nbsp;</td>
						</tr>
						<tr>
							<td colspan="<?php echo $total_col; ?>" style="font-size:12px;"><b>In Words.:</b> <?php 
							$tot_amount = round(($invoice['grand_total']),0);
							echo strtoupper(int_to_words($tot_amount)); ?> </td>
						</tr>
						<tr>
							<td colspan="4" style="border:0px solid;font-size:15px">&nbsp;</td>
						</tr>
						<?php
						if($firm_type=='non_composition'){
						...
						<tr>
							...
							<td colspan="<?php echo $total_col; ?>" style="border:none;">
								<div style="width: 100%; border: 0px solid; float: left;margin-top:-10px;">
	...
	<body>
		<div id="wrapper">
			...
			<div id="company_info">
				<center><p style="font-size:14px; text-decoration: underline;"><?php if($invoice['invoice_type']=='SALE'){echo "INVOICE";}elseif($invoice['invoice_type']=='TAX'){echo "INVOICE";}else{echo "";}?></p></center>
				<div id="company">
					<div id="logo">INDRAPRASTHA INN <br/><br/></div>
				</div>
				<div id="address">
					<?php echo $address; ?><br />
					<?php echo $contact; ?>
