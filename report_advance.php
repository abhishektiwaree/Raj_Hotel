	...
	<form action="report_advance.php" id="report_form" class="wufoo leftLabel page1" name="addnewdesignation"
		...
		<table width="100%">
			...
			<tr>
				<td>Guest Name</td>
				<td>
					<input type="text" name="cust_name" id="cust_name" value="<?php if (isset($_POST['cust_name'])) {
						echo $_POST['cust_name'];
					} ?>">
					<input type="hidden" name="cust_sno" id="cust_sno" value="<?php if (isset($_POST['cust_sno'])) {
						echo $_POST['cust_sno'];
					} ?>">
				</td>
				<!-- <td>Company Name</td>
