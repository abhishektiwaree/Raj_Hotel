	 ...
	 $sql_summary=$_SESSION['sql7'];
       ...
       $html ='<table>
			...
			$html .='<tr style="background:'.$col.';border:1px solid black">
				...
				<th class="right" style="color:black;font-size:18px;">'.round($tot_tax,2).'</th>
			...
			$html .='<tr style="background:'.$col.';border:1px solid black">
				...
				<th class="right" style="color:black;font-size:18px;">'.round($row_sum['tot_vat']+$row_sum['tot_sat'],2).'</th>
				...
				$html .='<table>
					...
					while($row1 = mysqli_fetch_assoc($result2)){
						...
						<td class="right" style="color:black;font-size:18px;">'.$row1['grand_total'].'</td>
						</tr>';
