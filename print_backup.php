...
<?php
	...
	<div id="wrapper" style="page-break-after:avoid; margin-left:25px;margin-top:15px;">
		<table width="100%" border="0" style="border-bottom: 1px solid;" cellpadding="0" cellspacing="0">
			...
			<tr>
				<td align="left">S.Tax No : 09AACCP0999C1ze</td>
		...
		<table width="100%" class="td-center">
			...
			<tr>
				...
				<td>Rs.<?php echo $details['room_rent']; ?></td>
			</tr>
			<?php 
				$start = date("d-m-Y H:i:s", strtotime($start)+86400);
			}
		...
		<tr>
			...
			<td> Rs.<?php if($tot>1000){ $sgst= $tot*6/100; echo $sgst;} else{$sgst=0;echo"0";} ?></td>
		</tr>
		<tr>
			<td colspan="<?php echo $colspan-1; ?>" >CGST 6% on amount [<?php echo $tot;  ?>]</td>
			<td>Rs.<?php if($tot>1000){ $cgst= $tot*6/100; echo $cgst;}else{$cgst=0;echo"0";} ?></td>
		</tr>
		<tr>
			<td colspan="<?php echo $colspan+1; ?>" style="border-top:1px solid;">
